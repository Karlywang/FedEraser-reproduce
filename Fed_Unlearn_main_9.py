...
class Arguments():
    def __init__(self):
        ...
        self.unlearn_interval= 9#Used to control how many rounds the model parameters are saved.1 represents the parameter saved once per round  N_itv in our paper.
